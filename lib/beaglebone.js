...
var PINS = {
  "P8_3":  38, "P8_4":  39,  "P8_5":  34, "P8_6":  35, "P8_7":  66,
  "P8_8":  67, "P8_9":  69,  "P8_10": 68, "P8_11": 45, "P8_12": 44,
  ...
  "P8_33":  9, "P8_34": 81,  "P8_37": 78, "P8_38": 79, "P8_39": 76,
  "P8_40": 77, "P8_41": 74,  "P8_42": 75, "P8_43": 72, "P8_44": 73,
  "P8_45": 70, "P8_46": 71,  "P9_11": 30, "P9_12": 60, "P9_13": 31,
  "P9_14": 50, "P9_15": 48,  "P9_16": 51, "P9_17":  5, "P9_18":  4,
  "P9_19": 13, "P9_20": 12,  "P9_21":  3, "P9_22":  2, "P9_23": 49,
  "P9_24": 15, "P9_25": 117, "P9_26": 14, "P9_27": 115, "P9_28": 113,
  "P9_29": 111,"P9_30": 112, "P9_31": 110
};
...
Beaglebone.prototype.servoWrite = function(pinNum, scaledDuty, freq, pulseWidth) {
  this.pwmWrite(pinNum, scaledDuty, freq, pulseWidth, 'servo');
};
...
Beaglebone.prototype._muxPin = function(type, args) {
  ...
  switch(type){
    case 'pwm':
      ...
      pin = this.pwmPins[gpioPinNum] || this._newPwmPin(gpioPinNum, args.period);
    ...
    case 'digital':
      ...
      pin = this.pins[gpioPinNum] || this._newDigitalPin(gpioPinNum, args.mode);
      this.pins[gpioPinNum] = pin;
      break;
    case 'i2c':
      pin = this.i2cDevices[args.address] || this._newI2CDevice(args.address);
...
Beaglebone.prototype._i2cDevice = function(address) {
  return this._muxPin('i2c', { address: address });
};

Beaglebone.prototype._pwmPin = function(pinNum, period) {
  return this._muxPin('pwm', { pinNum: pinNum, period: period});
};

Beaglebone.prototype._analogPin = function(pinNum) {
  return this._muxPin('analog', { pinNum: pinNum });
};

Beaglebone.prototype._digitalPin = function(pinNum, mode) {
  return this._muxPin('digital', { pinNum: pinNum, mode: mode });
};
