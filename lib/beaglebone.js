...
Beaglebone.prototype.analogRead = function(pinNum, drCallback) {
  ...
  if (pin == null) {
    ...
    pin.on("analogRead", function(val) {
      this.respond("analogRead", drCallback, null, val, pinNum);
    }.bind(this));
 ...
 * @publish
 */
Beaglebone.prototype.i2cWrite = function(address, cmd, buff, drCallback) {
  buff = buff != null ? buff : [];
 ...
 * @publish
 */
Beaglebone.prototype.i2cRead = function(address, cmd, length, drCallback) {
  var callback = function() {
